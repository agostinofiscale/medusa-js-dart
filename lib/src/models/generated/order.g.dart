...
Map<String, dynamic> _$OrderToJson(Order instance) {
  ...
  val['gift_cards'] = instance.giftCards.map((e) => e.toJson()).toList();
  ...
  val['returns'] = instance.returns.map((e) => e.toJson()).toList();
  val['claims'] = instance.claims.map((e) => e.toJson()).toList();
  val['refunds'] = instance.refunds.map((e) => e.toJson()).toList();
  val['swaps'] = instance.swaps.map((e) => e.toJson()).toList();
