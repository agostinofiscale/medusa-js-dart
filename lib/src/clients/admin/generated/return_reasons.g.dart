...
class _ReturnReasonsResource implements ReturnReasonsResource {
  ...
  Future<AdminReturnReasonsListRes> list(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AdminReturnReasonsListRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AdminReturnReasonsListRes.fromJson(_result.data!);
    return value;
  }
  ...
  Future<AdminReturnReasonsRes> create(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AdminReturnReasonsRes>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AdminReturnReasonsRes.fromJson(_result.data!);
    return value;
  }
  ...
  Future<AdminReturnReasonsDeleteRes> delete(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AdminReturnReasonsDeleteRes>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AdminReturnReasonsDeleteRes.fromJson(_result.data!);
    return value;
  }
