...
class _StoresResource implements StoresResource {
  ...
  Future<AdminExtendedStoresRes> retrieve(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AdminExtendedStoresRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AdminExtendedStoresRes.fromJson(_result.data!);
    return value;
  }
  ...
  Future<AdminStoresRes> update(
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AdminStoresRes>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AdminStoresRes.fromJson(_result.data!);
    return value;
  }
